# Video Game Art Director repository instructions

This repository contains one standalone C-Sweet protocol-v2 agent. Its purpose is:

> Owns art direction, visual targets, asset briefs, consistency review, and final visual findings.

## Invariants

- Keep `com.csweet.video-game-art-director` and version `2.1.1` synchronized between agent code,
...
```powershell
dotnet test
dotnet run --project src/CSweet.Agent.ArtDirector.VideoGame -- --self-test
```
